...
| `getCellData`         | --                       |             | `(<T = string>(key: T) => any) \| undefined`                   | `undefined`       |
| `getNestedCellData`   | --                       |             | `(<T = string>(key: T) => any) \| undefined`                   | `undefined`       |
| `getNestedRows`       | --                       |             | `((key: string) => any[] \| undefined) \| undefined`           | `undefined`       |
