...
| `renderAfter`              | --                | Display in a row after the last row                                                                                     | `(h: typeof h) => string \| VNode \| VNode[] \| null`                                      | `() => null`          |
| `renderBefore`             | --                | Display in a row before the first row                                                                                   | `(h: typeof h) => string \| VNode \| VNode[] \| null`                                      | `() => null`          |
