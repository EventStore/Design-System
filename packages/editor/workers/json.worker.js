    ...
    *--------------------------------------------------------------------------------------------*/
    ...
    var URI$1 = /** @class */ (function () {
        ...
        Object.defineProperty(URI.prototype, "fsPath", {
            ...
            get: function () {
                ...
                // 	console.warn(`[UriError] calling fsPath with scheme ${this.scheme}`);
                // }
                return uriToFsPath$1(this, false);
            },
            enumerable: true,
            configurable: true
        });
        ...
        URI.parse = function (value, _strict) {
            ...
            if (!match) {
                return new _URI(_empty$1, _empty$1, _empty$1, _empty$1, _empty$1);
            }
            return new _URI(match[2] || _empty$1, percentDecode$1(match[4] || _empty$1), percentDecode$1(match[5] || _empty$1), percentDecode$1(match[7] || _empty$1), percentDecode$1(match[9] || _empty$1), _strict);
        };
        /**
         * Creates a new URI from a file system path, e.g. `c:\my\files`,
         * `/usr/home`, or `\\server\share\some\path`.
        ...
        URI.file = function (path) {
            ...
            return new _URI('file', authority, path, _empty$1, _empty$1);
        };
    ...
    var _URI = /** @class */ (function (_super) {
        ...
        Object.defineProperty(_URI.prototype, "fsPath", {
            get: function () {
                if (!this._fsPath) {
                    this._fsPath = uriToFsPath$1(this, false);
                }
                return this._fsPath;
            },
            enumerable: true,
     ...
     * Compute `fsPath` for the given uri
     */
    function uriToFsPath$1(uri, keepDriveLetterCasing) {
        var value;
        if (uri.authority && uri.path.length > 1 && uri.scheme === 'file') {
            // unc path: file://shares/c$/far/boo
            value = "//" + uri.authority + uri.path;
    ...
    // --- decode
    function decodeURIComponentGraceful$1(str) {
        try {
            return decodeURIComponent(str);
        }
        catch (_a) {
            if (str.length > 3) {
                return str.substr(0, 3) + decodeURIComponentGraceful$1(str.substr(3));
            }
            else {
                return str;
            }
    ...
    var _rEncodedAsHex$1 = /(%[0-9A-Za-z][0-9A-Za-z])+/g;
    function percentDecode$1(str) {
        if (!str.match(_rEncodedAsHex$1)) {
            return str;
        }
        return str.replace(_rEncodedAsHex$1, function (match) { return decodeURIComponentGraceful$1(match); });
    }
