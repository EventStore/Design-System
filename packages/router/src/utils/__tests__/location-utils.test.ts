...
describe('createLocation', () => {
    ...
    describe('with a path with no pathname', () => {
        describe('given as a string', () => {
            it('has the correct properties', () => {
                expect(
                    createLocation('?the=query#the-hash', undefined, ''),
                ).toEqual({
                    pathname: '/',
                    search: '?the=query',
                    hash: '#the-hash',
    ...
    describe('with a path with no search', () => {
        describe('given as a string', () => {
            it('has the correct properties', () => {
                expect(
                    createLocation('/the/path#the-hash', undefined, ''),
                ).toEqual({
                    pathname: '/the/path',
                    search: '',
                    hash: '#the-hash',
    ...
    describe('with a path with no hash', () => {
        describe('given as a string', () => {
            it('has the correct properties', () => {
                expect(
                    createLocation('/the/path?the=query', undefined, ''),
                ).toEqual({
                    pathname: '/the/path',
                    search: '?the=query',
                    query: {
...
describe('valueEqual', () => {
    ...
    describe('number objects', () => {
        describe('that are equal', () => {
            it('returns true', () => {
                expect(
                    valueEqual(new Number(123.456), new Number(123.456)),
                ).toBe(true);
            });
        });
        ...
        describe('that are not equal', () => {
            it('returns false', () => {
                expect(
                    valueEqual(new Number(123.456), new Number(123.567)),
                ).toBe(false);
            });
        });
    });
    ...
    describe('boolean objects', () => {
        describe('that are equal', () => {
            it('returns true', () => {
                expect(valueEqual(new Boolean(true), new Boolean(true))).toBe(
                    true,
                );
            });
        });
    ...
    describe('date objects', () => {
        ...
        describe('that are not equal', () => {
            it('returns false', () => {
                expect(valueEqual(new Date(now), new Date(now + 1))).toBe(
                    false,
                );
            });
        });
